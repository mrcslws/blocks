---
layout: post
title: "HTM time series: Now add synapse learning"
...
Here I include the patchers from the
[previous](/blocks/2016/01/16/htm-column-time-series.html)
[posts](/blocks/2016/01/31/htm-segment-time-series.html), and I add a new one.
...
Use [d3.js](http://d3js.org/) to draw the CSV data. The code is pretty good,
though there's some room for cleanup.
